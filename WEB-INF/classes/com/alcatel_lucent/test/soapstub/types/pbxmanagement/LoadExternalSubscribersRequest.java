 ...
 *         &lt;element name="filters" type="{http://www.alcatel-lucent.com/wsp/ns/2008/03/26/ics/pbxmanagementSchema}AlcLoadExternalSubscribersFilter" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "loadExternalSubscribersRequest")
public class LoadExternalSubscribersRequest {

    @XmlElement(required = true, nillable = true)
    protected String fwSessionId;
    @XmlElement(required = true, nillable = true)
    protected String pbxName;
    protected List<AlcLoadExternalSubscribersFilter> filters;
     ...
     * {@link AlcLoadExternalSubscribersFilter }
     * 
     * 
     */
    public List<AlcLoadExternalSubscribersFilter> getFilters() {
        if (filters == null) {
            filters = new ArrayList<AlcLoadExternalSubscribersFilter>();
        }
        return this.filters;
    }
