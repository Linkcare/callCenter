 ...
 *         &lt;element name="filters" type="{http://www.alcatel-lucent.com/wsp/ns/2008/03/26/ics/pbxmanagementSchema}AlcLoadSubscribersFilter" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "loadSubscribersRequest")
public class LoadSubscribersRequest {

    @XmlElement(required = true, nillable = true)
    protected String fwSessionId;
    @XmlElement(required = true, nillable = true)
    protected String pbxName;
    protected List<AlcLoadSubscribersFilter> filters;
     ...
     * {@link AlcLoadSubscribersFilter }
     * 
     * 
     */
    public List<AlcLoadSubscribersFilter> getFilters() {
        if (filters == null) {
            filters = new ArrayList<AlcLoadSubscribersFilter>();
        }
        return this.filters;
    }
