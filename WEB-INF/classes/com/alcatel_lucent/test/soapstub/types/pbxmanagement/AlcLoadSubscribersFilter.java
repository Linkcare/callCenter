...
/**
 * Describes a filter used to load the Subscribers from a PBX.
 * 
 * <p>Java class for AlcLoadSubscribersFilter complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AlcLoadSubscribersFilter">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="field" type="{http://www.alcatel-lucent.com/wsp/ns/2008/03/26/ics/pbxmanagementSchema}AlcSubscriberField"/>
...
@XmlType(name = "AlcLoadSubscribersFilter", propOrder = {
    "field",
    "operator",
    "value",
    "filterCommand"
})
public class AlcLoadSubscribersFilter {

    @XmlElement(required = true)
    protected AlcSubscriberField field;
    @XmlElement(required = true)
     ...
     *     
     */
    public AlcSubscriberField getField() {
        return field;
    }
     ...
     *     
     */
    public void setField(AlcSubscriberField value) {
        this.field = value;
    }
