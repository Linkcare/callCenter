...
public class LoginRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the loginName value for this LoginRequest.
     * 
     * @return loginName
     */
    ...
    /**
     * Sets the loginName value for this LoginRequest.
     * 
     * @param loginName
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.alcatel-lucent.com/wsp/ns/2008/03/26/ics/frameworkSchema", "loginRequest"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.alcatel-lucent.com/wsp/ns/2008/03/26/ics/frameworkSchema", "password"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
